...
private val LightColorScheme = lightColorScheme(
    ...
    tertiary = Pink40,
    background = BackgroundColor, // Light background color
    surface = SurfaceColor, // Light surface color
    onPrimary = Color.White,
    onSecondary = Color.White,
    onTertiary = Color.White,
    onBackground = OnBackgroundColor, // Text color on background
    onSurface = OnBackgroundColor // Text color on surface
)


@Composable
fun CGPA_Calculator_MU_ResultTheme(
